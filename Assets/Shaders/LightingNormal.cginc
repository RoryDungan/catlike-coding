...
float3 GetAlbedo(Interpolators i) {
    ...
    return lerp(albedo, albedo * detail, GetDetailMask(i));
}
...
float3 ComputeBinormal(float3 normal, float3 tangent, float binormalSign) {
...
Interpolators vert(VertexData v)
{
    ...
    i.binormal = ComputeBinormal(i.normal, i.tangent, v.tangent.w);
#endif
...
void InitializeFragmentNormal(inout Interpolators i) {
    ...
    #if defined(BINORMAL_PER_FRAGMENT)
        float3 binormal = ComputeBinormal(i.normal, i.tangent.xyz, i.tangent.w);
    #else
